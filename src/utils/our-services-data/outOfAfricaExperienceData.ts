...
export const OutOfAfricaExperienceData = {
  introSectionTitle: "Out of Africa Experience",
  introSectionContent:
  ...
  timelines: [
    {
      ...
      text: "PICK UP",
      content:
        "Your adventure begins right at your doorstep! Our OUT OF AFRICA EXPERIENCE pickup service ensures that the magic starts the moment you step out of your home. ",
    },
    {
      icon: Girrafe,
      text: "STOP 01",
      content:
        "Prepare for an awe-inspiring encounter with the Rothschild giraffes, where guests can feed and interact with these majestic creatures. This rare and unforgettable experience provides an up-close look at one of Africa's most iconic animals.",
    },
    {
      icon: Museum,
      text: "STOP 02",
      content: `Enter the enchanting world of Karen Blixen at the Karen Blixen Museum, the first stop on your OUT OF AFRICA EXPERIENCE. Wander through the historic rooms of Blixen's former home, where she penned the timeless memoir "Out of Africa." `,
    },
    {
      icon: Beads,
      text: "STOP 03",
      content: `Visit to the Kazuri Beads Factory, where creativity meets tradition. Guests will witness the intricate process of handcrafting vibrant Kazuri beads, each telling a unique story. Engage with local artisans, learn about the cultural significance of these beads, and even have the chance to create your own masterpiece to take home.`,
    },
    {
      icon: DropOff,
      text: "DROP OFF",
      content: `As the OUT OF AFRICA EXPERIENCE concludes, our journey ends with the ultimate convenience for our valued guests. Sit back, relax, and enjoy the memories as you are dropped off at the doorstep of your own home.`,
    },
  ],
